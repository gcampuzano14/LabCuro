            ...
            for lab in structure[service]:
                ...
                for dirs in structure[service][lab]:
                   ...
                   # print treename
                    ...
                    file_model.setRootPath(str(path))
                    
                    
                    
                    #self.treeWidget = myTree(tree, dire, item_cases)
                    ...
                    #self.treeWidget = myTree(self.horizontalLayoutWidget, file_model)
                    #self.treeWidget.setObjectName(treename)
                    #self.increase[treename] = self.treeWidget
...
class myTree(QtGui.QTreeWidget):
    def __init__(self, parent, file_model):
        super(myTree, self).__init__(parent)
        
        #self.lab = lab
        #print lab
        self.realtreee(file_model)
        self.itemClicked.connect(lambda: self.cselect(self.currentItem()))
        

    def realtreee(self, file_model):
        print file_model
